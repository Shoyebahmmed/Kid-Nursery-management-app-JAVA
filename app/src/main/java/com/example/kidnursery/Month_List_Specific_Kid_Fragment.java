...
public class Month_List_Specific_Kid_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(strtext.equals("January")) {
            MyTask m = (MyTask)new MyTask().execute("1", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("2", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("3", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("4", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("5", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("6", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("7", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("8", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("9", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("10", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("11", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
            ...
            MyTask m = (MyTask)new MyTask().execute("12", cust_Name, cust_Number, Kid_Name);
            try {
...
//                    System.out.println("******************************************** 333 The ArrayList is not empty");
    ...
    class MyTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            cri.clear();
            Cursor cursor = db.getDataByMonth_Credit_ID(month, cust_name, cust_number, kid_name);
