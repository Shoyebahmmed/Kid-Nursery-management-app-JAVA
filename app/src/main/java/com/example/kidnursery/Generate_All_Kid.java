...
public class Generate_All_Kid extends AppCompatActivity implements Footer_Fragment.footerOnClickSetListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generate_all_kid);
        hideNavigationBar();
            ...
            public void onClick(View v) {
                ...
                if(gType.equals("Date")) {
                    ...
                    if(mType.equals("January")) {
                        ...
                        Month_List_Fragment mlf = new Month_List_Fragment();
                        FragmentManager fragmentManager = getSupportFragmentManager();
                        final FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        ...
        generateByYear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(validity) {
                    ...
                    Year_List_Fragment ylf = new Year_List_Fragment();
                    FragmentManager fragmentManager = getSupportFragmentManager();
                    final FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
        ...
        getGenerateByDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(validity)
                {
                    ...
                    yearContainer.setVisibility(View.GONE);
                    getYear.setVisibility(View.INVISIBLE);
                    Date_List_Fragment dlf = new Date_List_Fragment();
